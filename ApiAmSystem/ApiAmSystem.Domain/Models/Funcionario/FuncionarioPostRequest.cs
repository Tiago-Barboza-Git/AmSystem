...
namespace ApiAmSystem.Domain.Models.Funcionario
{
    public class FuncionarioPostRequest
    {
        ...
        public FuncionarioPostRequest(string pFuncionario, string? pApelido, string pCPF, string? pRG, DateTime? pDtNasciomento, string? pTelefone,
                                string pEmail, string pCelular, decimal? pSalario, string? pPis, string pCEP, string pLogradouro, string pBairro,
