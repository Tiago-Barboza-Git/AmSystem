...
{
    public class PessoaModel : PaiModel
    {
        ...
        public PessoaModel() : base()
        {

        }

        public PessoaModel(int pId, char pTpPessoa, string pPessoaRazaoSocial, string? pApelidoNomeFantasia, char? pSexo, string? pTelefone,
            string pCelular, string pEmail, string pCep, string pLogradouro, int pNumero, string? pComplemento, string pBairro,
            string pCpfCnpj, string? pIeRg, DateTime? pDtNascimento, int pIdCidade, bool pAtivo, DateTime pDtCadastro, DateTime pDtAlteracao) : base(pId, pAtivo, pDtCadastro, pDtAlteracao)
        {
