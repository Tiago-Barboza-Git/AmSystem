...
{
    public class PessoaPostRequest : PaiPostRequest
    {
        ...
        public PessoaPostRequest(): base()
        {

        }

        public PessoaPostRequest(char pTpPessoa, string pPessoaRazaoSocial, string? pApelidoNomeFantasia, char? pSexo, string? pTelefone, string pCelular,
            string pEmail, string pCep, string pLogradouro, int pNumero, string pBairro, string? pComplemento, string pCpfCnpj, string? pIeRg,
            int pIdCidade, DateTime? pDtNascimento, bool pAtivo) : base(pAtivo)
        {
