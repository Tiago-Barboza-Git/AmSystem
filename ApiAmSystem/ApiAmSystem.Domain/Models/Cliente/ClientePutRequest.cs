...
{
    public class ClientePutRequest: PessoaPutRequest
    {
        private string? Representante;
        private string? CelularRepresentante;   

        public ClientePutRequest()
        {
            this.Representante = string.Empty;
            this.CelularRepresentante = string.Empty;
        }

        public ClientePutRequest(int pId, char pTpPessoa, string pPessoaRazaoSocial, string pApelidoNomeFantasia, char? pSexo, string? pRepresentante, string? pCelularRepresentante, 
            ...
            bool pAtivo, DateTime? pDtNascimento, int pIdCidade): base(pId, pTpPessoa, pPessoaRazaoSocial, pApelidoNomeFantasia, pSexo, pRepresentante, pCelular, pEmail, pCep,
            pLogradouro, pNumero, pBairro, pComplemento, pCpfCnpj, pIeRg, pIdCidade, pDtNascimento, pAtivo)
        {
