...
namespace ApiAmSystem.Domain.Models.Cliente
{
    public class ClienteModel: PessoaModel
    {
        ...
        public ClienteModel(int pId, char pTpPessoa, string pPessoaRazaoSocial, string pApelidoNomeFantasia, char? pSexo, string? pRepresentante, string? pCelularRepresentante, 
            ...
            bool pAtivo, DateTime? pDtNascimento, DateTime pDtCadastro, DateTime pDtAlteracao, int pIdCidade): base(pId, pTpPessoa, pPessoaRazaoSocial, pApelidoNomeFantasia, pSexo, pTelefone,
            pCelular, pEmail, pCep, pLogradouro, pNumero, pComplemento, pBairro, pCpfCnpj, pIeRg, pDtNascimento, pIdCidade, pAtivo, pDtCadastro, pDtAlteracao)
        {
